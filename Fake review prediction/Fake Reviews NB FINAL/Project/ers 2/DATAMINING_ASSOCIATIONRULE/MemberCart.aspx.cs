        ...
        private void ViewCartDetails()
        {
            ...
            if (tab.Rows.Count > 0)
            {
                ...
                for (int i = 0; i < tab.Rows.Count; i++)
                {
                    ...
                    C23.Text = "Rs " + book.Rows[0]["Item_Cost"].ToString();
                    ...
                    del.Width = 50;
                    del.Height = 50;
                    del.ImageUrl = "../images/DeleteIcon.jpg";
                ...
                //Session["Customer_ID"] = tab.Rows[0]["UserID"].ToString();
            }
            else
            {
                Panelca2.Visible = false;
