            ...
            try
            {
                if (obj.Check_CustomerID_Avail(txt_EmailID.Text) && obj.Check_AdminID(txt_EmailID.Text))
                {
                    if (obj.Check_CustomerMobile_Avail(txt_contactNo.Text))
                    {
                        ...
                        obj.NewRegistration(txt_EmailID.Text, txt_Name.Text, txt_password.Text, dropdownlistGender.SelectedValue, null, dropdownlistMartialstatus.SelectedValue, null, null, null, DropDownList1.SelectedItem.Text, txt_contactNo.Text, txt_address.Text, TextBox1.Text, DropDownListAOI.SelectedItem.Text, "",
