...
<div class="wrapper">
  ...
  <div class="content-wrapper">
   ...
   <section class="content">
	 ...
	 error_reporting(0);
	  $s=$_SESSION['username']; 
	$query=("SELECT * from reqest where status='booked'");
...
?>
                ...
                <tr>
                  ...
                  <input type="hidden" readonly name="p1" value="<?php echo $data['rid']; ?>">
				  <td><?php echo $data['uid']; ?></td>
                   <td><?php echo $data['pname']; ?></td>
                   <td><?php echo $data['ft']; ?></td>
                   <td><?php echo $data['rt']; ?></td>
				  
                  <td> <a href="acceptorder.php?id=<?php echo $data['rid']; ?>" class="btn btn-block bg-gradient-success ">Accept</td>
                  <td> <a href="deleteorder.php?id=<?php echo $data['rid']; ?>" class="btn btn-block bg-gradient-danger ">Delete</td>
