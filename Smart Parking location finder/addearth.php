...
<nav class="mt-2">
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
		  ...
		  <li class="nav-item">
           ...
           View Google-Earth Location
		  		   ...
		  		   <li class="nav-item">
            <a href="mchat.php" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
           Manage Chatbot
          ...
          <li class="nav-item">
            <a href="http://localhost/parking/home/" class="nav-link">
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Add Google Earth Parking Slot</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body"> <a href="https://www.itilog.com/" target="_blank"><h4 class="card-title">Find Location</h4></a>
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
				   <form action="http://localhost/parking/earthdb.php"  method="post">
                  
               
                 
				  <td><input type="text" class="form-control" name="p1" required></td>
                  <td><input type="text" class="form-control"  name="p2" required></td>
				     <td><input type="number" class="form-control"   name="p3" required></td>
					     
					<td><input type="number" class="form-control" name="p4" required></td>
								 
				  <td><textarea class="form-control" name="p5" required></textarea></td>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2022 <a href="">Parking</a>.</strong>
    All rights reserved.
