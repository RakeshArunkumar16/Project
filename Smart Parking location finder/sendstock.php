        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Send Stock Request to Purchse Manager</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
				  ...
				  <option value="Sugar">Sugar</option>
				  				  <option value="Cooking_Oil">Cooking Oil</option>
				  <option value="Sugar">Rice</option>
				  ...
				  <option value="mushroom">mushroom</option></select>
				  
				  </select>
				  </td>
				  <td><input type="number" class="form-control" name="p2" required></td>
				 
                  <td><button type="submit" class="btn btn-block bg-gradient-success ">Send Request</button></td>
                </tr>
