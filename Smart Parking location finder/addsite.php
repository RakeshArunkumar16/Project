        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Add Parking Details</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body"> <a href="https://www.itilog.com/" target="_blank"><h4 class="card-title">Find Location</h4></a>
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
				   <form action="http://localhost/parking/propertydb.php"  method="post">
                  
                 <td><input type="text" class="form-control" readonly value="admin" name="p1" required></td>
