...
<nav class="mt-2">
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Add Auto Response</h3>
            </div>
            <!-- /.card-header -->
              ...
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
				   <form action="http://localhost/parking/chatdb.php"  method="post">
                  
               
                 <td><textarea class="form-control" name="p1" required></textarea></td>
				
								 
				  <td><textarea class="form-control" name="p2" required></textarea></td>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2022 <a href="">Parking Slot</a>.</strong>
    All rights reserved.
