...
<nav class="mt-2">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"> Organ Donation Information</h1>
          </div><!-- /.col -->
      ...
      <div class="row">
       ...
       <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Organ Donation Information</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                ...
                <div class="card-body">
				 ...
				 <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="exampleInputEmail1" name="p2" required placeholder="Enter Amount">
                  </div>
                 
				   <div class="form-group">
                    <label for="exampleInputEmail1">Donation Details</label>
					<textarea class="form-control" name="p3"></textarea>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2022 <a href="">OMS</a>.</strong>
    All rights reserved.
