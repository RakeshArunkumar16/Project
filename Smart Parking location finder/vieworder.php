  ...
  <section class="content">
      <div class="row">
        <div class="col-12">
		 ...
		 <?php
	 error_reporting(0);
	  $a=$_SESSION['cusername'];
	$query=("SELECT * from foodorder where cheffid='$a' and orderid NOT IN (select orderid from orderconfirmation)");
...
?>
                ...
                <tr><form action="uploadconfirm.php" method="post">
                  <td><input class="form-control" name="p1"type="text" value="<?php echo $data['orderid']; ?>"></td>
                  <td><?php echo $data['recipeid']; ?></td>
                  <td><?php echo $data['totalamount']; ?>Rs</td>
                  <td> <a href="https://www.truecaller.com/search/in/<?php echo $data['phone']; ?>" target="_blank" > Call</a></td>
				   <td> <a href="https://www.google.com/maps/place/<?php echo $data['address']; ?>" target="_blank"> Location </a></td>
				   ...
				   <td><textarea name="p3" class="form-control"></textarea>	</td>
                  <td><button type="submit" class="btn btn-block bg-gradient-success ">Submit</button></td>
                </tr>
<?php  }?></form>
                </tfoot>
              </table>
