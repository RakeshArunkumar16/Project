...
?>
                ...
                <tr>
                 ...
                 <td> <input type="text" name="p1" readonly value="<?php echo $data['eid']; ?>"></td>
				
                   <td><?php echo $data['ename']; ?> </td>
				  <td><?php echo $data['esize']; ?> Sqft | <?php echo $data['eprice']; ?> Rs</td>
				  
                  <td> <a href="<?php echo $data['elink']; ?>" target="_blank"> View In Google Earth </a></td>
