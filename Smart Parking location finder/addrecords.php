  ...
  <div class="content-wrapper">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
				   <form action="http://localhost/sap/ww.php"  method="post">
                  
               
                  <td> <select class="form-control" id="country" name="p1">
   <option value="Audior">Audior</option>
   <option value="Agent">Agent</option>
                  ...
                  <td><input type="text" class="form-control" name="p3" required></td>
				     <td><input type="password" class="form-control" name="p4" required></td>
					     
			<td> <select class="form-control"  name="p5">
