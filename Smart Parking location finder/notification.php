  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"> Order Notification</h1>
          </div><!-- /.col -->
    ...
    <section class="content">
	 ...
	 error_reporting(0);
	  $a=$_SESSION['username'];
	$query=("SELECT * from orderconfirmation where orderid in (select orderid from foodorder where userid='$a')");
             ...
             <div class="card-body">
                <div class="tab-content">
                  <div class="tab-pane active" id="tab_1">
                    <label> Oder ID       : <?php echo $data['orderid']; ?></label><br>
					<label> Order Status  : <?php echo $data['status']; ?></label><br>
					<label> Message from Cheff   : <?php echo $data['message']; ?> </label><br>
                  </div>
                  <!-- /.tab-pane -->
