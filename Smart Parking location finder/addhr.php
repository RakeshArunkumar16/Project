...
<nav class="mt-2">
          ...
          <li class="nav-item">
		   ...
		   <li class="nav-item">
            <a href="addrecords.php" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
            Add Records
		    ...
		    <li class="nav-item">
            <a href="viewrecords.php" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
            View Records
          ...
          <li class="nav-item">
            <a href="http://localhost/report/" class="nav-link">
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Add Human Resourse </h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
				   <form action="hrdb.php"  method="post">
                  
               
                  <td> <select class="form-control" name="p1">
                  ...
                  <td><input type="text" class="form-control" name="p3" required></td>
				     <td><input type="number" class="form-control" name="p4" required></td>
					     <td><input type="number" class="form-control" name="p5" required></td>
