  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"> Add Shipping Method</h1>
          </div><!-- /.col -->
...
?>
                ...
                <tr><form action="asignd.php" method="post">
                  <td><input class="form-control" name="p2"type="text" value="<?php echo $data['dusername']; ?>" readonly ></td>
                  <td><?php echo $data['status']; ?></td>
                  <td><input class="form-control" name="p3"type="text" ></td>
