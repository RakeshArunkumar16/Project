  ...
  error_reporting(0);
    ...
    if (isset($_REQUEST['p1'])){
		...
		$p3 = mysqli_real_escape_string($con,$p3);
		 if($p2 != $p3)
		 {
			 echo "<div class='form'><h3>passwords doesn't match.</h3><br/>Click here to <a href='userforgotpassword.php'>Here</a></div>";
		 }
			else{ 
 $query = "update `users` set password= '".md5($p2)."' where username='$p1'";
        $result = mysqli_query($con,$query);

        if($result){
            echo "<div class='form'><h3>You are updated successfully.</h3><br/>Click here to <a href='http://localhost/food/pages/examples/userlogin.php'>Login</a></div>";
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <p class="mt-3 mb-1">
        <a href="http://localhost/food/pages/examples/userlogin.php">Login</a>
      </p>
      <p class="mb-0">
        <a href="http://localhost/food/pages/examples/userregister.php" class="text-center">Register a new membership</a>
      </p>
    </div>
    <!-- /.login-card-body -->
	<?php }?>
