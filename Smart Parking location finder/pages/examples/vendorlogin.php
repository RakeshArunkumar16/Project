...
and cpassword='".md5($password)."'";
	...
	$rows = mysqli_num_rows($result);
	    ...
	    header("Location: http://localhost/food/viewstockrequest.php");
         }else{
	echo "<div class='form'>
<h3>Username/password is incorrect.</h3>
<br/>Click here to <a href='vendorlogin.php'>Login</a></div>";
	}
    }else{
?>
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Sign in to Start vendor Session</p>
