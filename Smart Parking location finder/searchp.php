...
?>
                ...
                <tr>
                 ...
                 <td> <input type="text" name="p1" readonly class="form-control" value="<?php echo $data['pid']; ?>"></td>
				 <td> <input type="text" name="p2" readonly class="form-control" value="<?php echo $_SESSION['username']; ?>"></td>
                  ...
                  <td> <a href="https://www.google.com/maps/search/<?php echo $data['lt']; ?>,<?php echo $data['lg']; ?>" target="_blank"> DIRECTION </a></td>
				   <td><img class="img-fluid pad" src="img/<?php echo $data['img']; ?>" width="250" height="300" alt="Photo"></td>
				<td><button type="submit" class="btn btn-block bg-gradient-success ">Book Slot</button></td>
				  </form>
                </tr>
<?php } ?>
                </tfoot>
