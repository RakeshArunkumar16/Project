...
<nav class="mt-2">
  ...
  <div class="content-wrapper">
   ...
   <section class="content">
	...
	$query=("SELECT * from stockrequest order by squantity DESC");
...
?>
                ...
                <tr>
                  ...
                  <td> <input type="text" name="p1" value="<?php echo $data['sid']; ?>" readonly class="form-control"></td>
				  <td><?php echo $data['sitem']; ?></td>
                  <td> <?php echo $data['squantity']; ?></td>
