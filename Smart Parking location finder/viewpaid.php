  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
   ...
   <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            <a href="viewpaid.php" class="nav-link active">
...
?>
                ...
                <tr>
                  ...
                  <input type="hidden" readonly name="p1" value="<?php echo $data['id']; ?>">
				  <td><?php echo $data['uid']; ?></td>
                   <td>&#8377 <?php echo $data['price']; ?></td>
				  <td><?php echo $data['tid']; ?></td>
				  
                  <td> <a href="acceptpayment.php?id=<?php echo $data['id']; ?>" class="btn btn-block bg-gradient-success ">Accept</td>
