...
if (isset($_REQUEST['username'])){
	...
	$trn_date = date("Y-m-d H:i:s");
        $query = "UPDATE users SET cphone='$cphone',caddress='$caddress',email='$email' where username='$username'";
             ...
             <div class="card-body">
                <div class="tab-content">
                  <div class="tab-pane active" id="tab_1">
					...
					<label> Username    : <input type="text" class="form-control"  readonly name="username" value="<?php echo $_SESSION['username']; ?>" >    </label><br>
					<label> Full Name : <input type="text" name="fullname" class="form-control" value="<?php echo $data['fullname']; ?>" ></label><br>
					<label> User Email  : <input type="text" name="email" class="form-control" value="<?php echo $data['email']; ?>" > </label><br>
						
					<label> Phone   : <input type="text" name="cphone" class="form-control" value="<?php echo $data['cphone']; ?>" ></label><br>
					<label> Address  : <input type="text" name="caddress" class="form-control" value="<?php echo $data['caddress']; ?>" > </label><br>
