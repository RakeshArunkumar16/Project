...
<div class="wrapper">
  ...
  <div class="content-wrapper">
   ...
   <section class="content">
	 ...
	 error_reporting(0);
	  $a=$_SESSION['username'];
	$query=("SELECT * from report where tid in ( select taskid from task where adid='$a')");
            ...
            <div class="card-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
				  ...
				  <td><?php echo $data['tstatus']; ?></td>
                  <td> <?php echo $data['odetails']; ?></td>
...
<?php } ?>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2020 <a href="">SAP</a>.</strong>
    All rights reserved.
