...
?>
                ...
                <tr>
                  ...
                  <td> <input type="text" value="<?php echo $data['username']; ?>" class="form-control" name="p1"></td>
				  <td><?php echo $data['fullname']; ?></td>
                  <td> <?php echo $data['email']; ?></td>
				  <td><?php echo $data['cphone']; ?></td>
                  <td> <?php echo $data['caddress']; ?></td>
				 
                  <td><button type="submit" class="btn btn-block bg-gradient-success ">Delete Profile</button></td>
				  </form>
                </tr>
<?php } ?>
                </tfoot>
