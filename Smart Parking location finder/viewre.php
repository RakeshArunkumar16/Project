  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"> Receiver Dashboard</h1>
          </div><!-- /.col -->
...
?>
        ...
        <th>Feedback</th>
				...
				<form action="res.php" method="POST">
                  ...
                  <td><input type="text" readonly name="p1" value="<?php echo $data['aid']; ?>"></td>
                  
				  <td><?php echo $data['agid']; ?></td>
                  <td> <?php echo $data['message']; ?></td>
                  <td><textarea name="p2"> </textarea></td>
			
				<td> <button type="submit" class="btn btn-block bg-gradient-success ">Send Response</button></td>
